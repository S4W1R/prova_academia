  ...
  <body>
    ...
    <section class="section__container signup__container">
      <div class="signup__content">
        <h2 class="section__header">Gerênciamento de Aluno</h2>
        <!-- Formulário de cadastro -->
        <form action="" method="POST" class="signup__form">
          
            <!-- Campo de nome-->
            <div class="form__group">
            <label for="confirm-password">Nome</label>
            <input 
                type="text" 
                id="text"
                name="text" 
...
input
          <!-- Campo de data-->
          <div class="form__group">
            <label for="confirm-password">Data de nacimento</label>
           <input 
                type="date" 
                id="date"
                name="date" 
                placeholder="Confirme sua data de nacimento"
                required
            />
            </div>
